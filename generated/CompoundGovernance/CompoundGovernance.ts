...
export class CompoundGovernance__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class CompoundGovernance extends ethereum.SmartContract {
  static bind(address: Address): CompoundGovernance {
    return new CompoundGovernance("CompoundGovernance", address);
  }
  ...
  checkpoints(
    param0: Address,
    param1: BigInt,
  ): CompoundGovernance__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new CompoundGovernance__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt,
  ): ethereum.CallResult<CompoundGovernance__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new CompoundGovernance__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
