...
export class UniGovernance__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniGovernance extends ethereum.SmartContract {
  static bind(address: Address): UniGovernance {
    return new UniGovernance("UniGovernance", address);
  }
  ...
  checkpoints(
    param0: Address,
    param1: BigInt,
  ): UniGovernance__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new UniGovernance__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt,
  ): ethereum.CallResult<UniGovernance__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new UniGovernance__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
